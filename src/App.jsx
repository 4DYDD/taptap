    ...
    <>
      <section className="h-screen flex flex-col">
        ...
        <div className="font-bold flex flex-col justify-center items-center flex-[8]">
          <div className="w-full flex flex-col justify-center items-center bg-yellow-200 h-48 text-center text-yellow-600 py-32">
            ...
            <div className="flex justify-center items-center gap-8">
              <div className="size-24">
                <div className="flex justify-center items-center flex-col">
                  <img src={house} alt="house" className="size-full mb-1" />
                  <div className="w-full">
                    {10 - money < 1 ? (
                      <span className="text-green-200 bg-green-600 block py-1 rounded-lg text-center text-xs">
                        bisa dibeli ✅
                      </span>
                    ) : (
                      `\$${10 - money}`
          ...
          <div className="w-full flex flex-col justify-center items-center bg-yellow-500 h-full">
            {/* GOA */}
      ...
      <footer className="bg-slate-600 text-white text-xs flex justify-center items-center flex-col py-5 gap-3">
        <a
          className="inline-block text-center shadow shadow-slate-800 p-2 rounded-lg bg-slate-800"
